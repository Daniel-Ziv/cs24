...
export const ieYearOneCourses = [
  { id: 501, name: "פיסיקה 1 למהנדסים", driveLink: "#" },
  { id: 502, name: "אינפי 1", driveLink: "#" },
  { id: 503, name: "אלגברה לינארית", driveLink: "#" },
  { id: 504, name: "מיתוג ותכנון לוגי", driveLink: "#" },
  { id: 505, name: "תכנות C", driveLink: "#" },
  { id: 506, name: "חשבון אינפיניטסימלי 2 למהנדסים", driveLink: "#" },
  { id: 507, name: "משוואות דיפרנציאליות רגילות", driveLink: "#" },
  { id: 508, name: "טורים והתמרות אינטגראליות", driveLink: "#" },
  { id: 509, name: "מעבדה לפיסיקה 1 למהנדסים", driveLink: "#" },
  { id: 510, name: "פיסיקה 2 למהנדסים", driveLink: "#" },
  ];

export const ieYearTwoCourses = [
  { id: 601, name: "הסתברות למהנדסים", driveLink: "#" },
  { id: 602, name: "מעבדה לפיסיקה 2 למהנדסים", driveLink: "#" },
  { id: 603, name: "משוואות דיפרנציאליות חלקיות", driveLink: "#" },
  { id: 604, name: "פיסיקה 3 למהנדסים", driveLink: "#" },
  { id: 605, name: "פונקציות מורכבות למהנדסים", driveLink: "#" },
  { id: 606, name: "מעבדה לכלי תוכנה למהנדסים", driveLink: "#" },
  { id: 607, name: "מבוא להנדסת חשמל", driveLink: "#" },
  { id: 608, name: "יסודות מוליכים למחצה", driveLink: "#" },
  { id: 609, name: "מעבדה להנדסת חשמל", driveLink: "#" },
  { id: 610, name: "מבוא למערכות ליניאריות", driveLink: "#" },
  { id: 611, name: "אותות ומערכות", driveLink: "#" },
  { id: 612, name: "שדות אלקטרומגנטיים", driveLink: "#" },
  { id: 613, name: "מדע נתונים-תאוריה ומעשה", driveLink: "#" },
  { id: 614, name: "קדם פרויקט ופיתוח מיומנויות רכות לסטודנטים", driveLink: "#" }
];

export const ieYearThreeCourses = [
  { id: 701, name: "התקני מוליכים למחצה", driveLink: "#" },
  { id: 702, name: "אותות אקראיים", driveLink: "#" },
  { id: 703, name: "מבוא למערכות תקשורת", driveLink: "#" },
  { id: 704, name: "עבוד אותות ספרתי", driveLink: "#" },
  { id: 705, name: "בקרה א", driveLink: "#" },
  { id: 706, name: "גלים ומערכות מפולגות", driveLink: "#" },
  { id: 707, name: "מעבדה למיקרו בקרים", driveLink: "#" },
  { id: 708, name: "מעגלים ספרתיים", driveLink: "#" },
  { id: 709, name: "מעגלים אלקטרוניים ליניאריים", driveLink: "#" },
  { id: 710, tag: 'בקרה', name: "בקרה אוטומטית מתקדמת (בקרה ב')", driveLink: "#"},
  { id: 711, tag: 'בקרה',  name: "מבוא לבקרה ליניארית מתקדמת", driveLink: "#" },
  { id: 712, tag: 'בקרה', name: "מעבדה לבקרה", driveLink: "#"},
  { id: 713, tag: 'ביו הנדסה', name: "פרקים נבחרים בכימיה וביולוגיה", driveLink: "#" },
  { id: 714, tag: 'ביו הנדסה', name: "אנטומיה ופיזיולוגיה של גוף האדם", driveLink: "#" },
  { id: 715, tag: 'ביו הנדסה', name: "מעבדה לעיבוד אותות ספרתי", driveLink: "#" },
  { id: 716, tag: 'אלקטרואופטיקה ומיקרואלקטרוניקה', name: "טכנולוגיות מיקרואלקטרוניקה", driveLink: "#" },  
  { id: 717, tag: 'אלקטרואופטיקה ומיקרואלקטרוניקה', name: "מבוא לאופטיקה מודרנית ואלקטרואופטיקה", driveLink: "#" },
  { id: 718, tag: 'אלקטרואופטיקה ומיקרואלקטרוניקה', name: "פוטוניקה ומערכות אלקטרואופטיות", driveLink: "#" },
  { id: 719, tag: 'אלקטרואופטיקה ומיקרואלקטרוניקה', name: "מעבדה לאלקטרואופטיקה", driveLink: "#" },
  { id: 720, tag: 'תקשורת ועיבוד אותות', name: "מבוא למיקרוגלים", driveLink: "#" },
  { id: 721, tag: 'תקשורת ועיבוד אותות', name: "רשתות מחשבים", driveLink: "#" },
  { id: 722, tag: 'תקשורת ועיבוד אותות', name: "מעבדה למיקרו בקרים", driveLink: "#" },
  { id: 723, tag: 'תקשורת ועיבוד אותות', name: "מעבדה להנדסת תקשורת", driveLink: "#" },
  { id: 724, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "מערכות הספק ב", driveLink: "#" },
  { id: 725, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "מעבדה להמרת אנרגיה", driveLink: "#" },
  { id: 727, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "טכניקות מתח גבוה", driveLink: "#" },
  { id: 728, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "התקני מתח גבוה ונמוך", driveLink: "#" },
  { id: 729, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "מערכות הספק אלקטרוניות", driveLink: "#" },
  { id: 730, tag: ['אנרגיה ומערכות הספק(זרם חזק)','אנרגיות חלופיות ומערכות הספק משולב'], name: "המרת אנרגיה א", driveLink: "#" },
  { id: 731, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "הינע חשמלי", driveLink: "#" },
  { id: 732, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "תהליכים אנרגטיים ושימור אנרגיה", driveLink: "#" },
  { id: 733, tag: 'מערכות משובצות מחשב', name: "אלגוריתמים ומבני נתונים", driveLink: "#" },
  { id: 734, tag: 'מערכות משובצות מחשב', name: "מעבדה מתקדמת בתכנות", driveLink: "#" },
  { id: 735, tag: 'מערכות משובצות מחשב', name: "תיכון חומרה באמצעות VHDL", driveLink: "#" },



];
export const ieYearFourCourses = [
  { id: 801, tag: 'בקרה', name: "מעבדה מתקדמת לבקרה", driveLink: "#" },
  { id: 802, name: "מעבדה להתקנים אלקטרוניים", driveLink: "#" },
  { id: 803, name: "פרוייקט גמר", driveLink: "#" },
  { id: 804, tag: 'בקרה', name: "מעבדה לאלקטרוניקה תקבילית", driveLink: "#"},
  { id: 805, tag: 'בקרה', name: "מעבדה לעיבוד אותות ספרתי", driveLink: "#"},
  { id: 807, tag: 'ביו הנדסה',  name: "מעבדה לעיבוד אותות פיזיולוגיים", driveLink: "#" },
  { id: 808, tag: 'ביו הנדסה', name: "עקרונות מכשור רפואי", driveLink: "#" },
  { id: 809, tag: 'ביו הנדסה', name: "מבוא לנירופרוטזות", driveLink: "#" },
  { id: 810, tag: 'ביו הנדסה', name: "חיישנים ביו רפואיים", driveLink: "#" },
  { id: 811, tag: 'ביו הנדסה', name: "מעבדה למיכשור רפואי", driveLink: "#" },
  { id: 812, tag: 'ביו הנדסה', name: "שיטות למידת מכונה לניתוח אותות FMRI", driveLink: "#" },
  { id: 813, tag: 'תקשורת ועיבוד אותות', name: "תקשורת ספרתית מתקדמת", driveLink: "#" },
  { id: 814, tag: 'תקשורת ועיבוד אותות', name: "נושאים נבחרים בעיבוד אותות", driveLink: "#" },
  { id: 815, tag: 'תקשורת ועיבוד אותות', name: "מערכות תקשורת בסיב אופטי", driveLink: "#" },
  { id: 816, tag: 'תקשורת ועיבוד אותות', name: "למידה עמוקה לראייה ממוחשבת", driveLink: "#" },
  { id: 817, tag: 'תקשורת ועיבוד אותות', name: "אנטנות וקרינה", driveLink: "#" },
  { id: 818, tag: 'תקשורת ועיבוד אותות', name: "אנליזה וסימולציה של רשתות מחשבים", driveLink: "#" },
  { id: 819, tag: 'תקשורת ועיבוד אותות', name: "מעבדה לתקשורת ספרתית", driveLink: "#" },
  { id: 841, tag: 'תקשורת ועיבוד אותות', name: "מודולים בתכנון מערכות תקשורת", driveLink: "#" },
  { id: 819, tag: 'תקשורת ועיבוד אותות', name: "עיבוד תמונה", driveLink: "#" },
  { id: 820, tag: 'תקשורת ועיבוד אותות', name: "מערכות תקשורת MIMO", driveLink: "#" },
  { id: 821, tag: 'תקשורת ועיבוד אותות', name: "עקרונות מכמ", driveLink: "#" },
  { id: 822, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "מערכות הספק א", driveLink: "#" },
  { id: 823, tag: 'אנרגיה ומערכות הספק(זרם חזק)', name: "הינע חשמלי", driveLink: "#" },
  { id: 824, tag: ['אנרגיה ומערכות הספק(זרם חזק)','אנרגיות חלופיות ומערכות הספק משולב'], name: "מעבדה לטכניקות מתח גבוה", driveLink: "#" },
  { id: 825, tag: ['אנרגיה ומערכות הספק(זרם חזק)','אנרגיות חלופיות ומערכות הספק משולב'], name: "מעבדה למערכות הספק אלקטרוניות", driveLink: "#" },
  { id: 826, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "מערכות הספק ב'", driveLink: "#" },
  { id: 827, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "מעבדה להמרת אנרגיה", driveLink: "#" },
  { id: 828, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "התקני מתח גבוה ונמוך", driveLink: "#" },
  { id: 829, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "מערכות הספק אלקטרוניות", driveLink: "#" },
  { id: 830, tag: 'אנרגיות חלופיות ומערכות הספק משולב', name: "מעבדה לאנרגיות חלופיות", driveLink: "#" },
  { id: 831, tag: 'מערכות משובצות מחשב', name: "מבוא לארכיטקטורת מחשבים", driveLink: "#" },
  { id: 832, tag: 'מערכות משובצות מחשב', name: "שפת תכנון חומרה וורילוג", driveLink: "#" },
  { id: 833, tag: 'מערכות משובצות מחשב', name: "ראייה ממוחשבת", driveLink: "#" },
  { id: 834, tag: 'מערכות משובצות מחשב', name: "תכן שבבי VLSI", driveLink: "#" },
  { id: 835, tag: 'מערכות משובצות מחשב', name: "סייבר למערכות זמן אמת", driveLink: "#" },
  { id: 836, tag: 'מערכות משובצות מחשב', name: "אפיון ותכנון ממ'מ", driveLink: "#" },
  { id: 837, tag: 'מערכות משובצות מחשב', name: "מעבדה למערכות זמן אמת משובצות מחשב", driveLink: "#" },
  { id: 838, tag: 'מערכות משובצות מחשב', name: "מעבדה ל-VHDL", driveLink: "#" },
  { id: 839, tag: 'מערכות משובצות מחשב', name: "מעבדה במערכות מחשב משובצות ב-IoT", driveLink: "#" },
  { id: 840, tag: 'מערכות משובצות מחשב', name: "מעבדה למערכות משובצות מיקרופרוססורים", driveLink: "#" },
